...
RSpec.describe AlertChecker do
  ...
  context "code with no alert" do
    subject { AlertChecker.new("/usr/local", "fizzbuzz.rb", "Hello") }
  ...
  context "code with an alert" do
    subject { AlertChecker.new("/usr/local", "fizzbuzz.rb", "x=3; alert('error');") }
  ...
  context "code with a flash[:alert]" do
    subject { AlertChecker.new("/usr/local", "fizzbuzz.rb", "x=3; flash[:alert] = 'Nooooo!';") }
